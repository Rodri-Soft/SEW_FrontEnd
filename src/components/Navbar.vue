<template>
    ...
    <MDBNavbar expand="lg" light container class="shadow-1 ">
        ...
        <MDBNavbarToggler id="toggleNavbar" @click="collapse1 = !collapse1" target="#navbarSupportedContent">
        </MDBNavbarToggler>
                    ...
                    <form class="d-flex input-group w-auto">
                        <div class="d-flex align-items-center search-container">
                            ...
                            <MDBDropdown v-model="dropdown1">
                                ...
                                <a id="filterButton" class="m-2 color-button" href="#" @click="dropdown1 = !dropdown1">
        ...
        <MDBNavbarNav class="me-3 me-lg-0 d-flex flex-row navbar-notifications">            
            ...
            <MDBNavbarItem to="#" class="me-3 me-lg-3">
                ...
                <MDBDropdown to="" v-model="dropdownBellNotifications">
...
<style scoped src="@/wwwroot/css/navbar.css">
